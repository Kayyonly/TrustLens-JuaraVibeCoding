...
const pageCopy: Record<"id" | "en", EducationCopy> = {
  id: {
    eyebrow: "DOCUMENTS / LEARN",
    title: "Pusat Intelijen & Edukasi Penipuan AI",
    subtitle: "Panduan premium untuk memahami cara memakai TrustLens, membaca pola psikologi scam, dan mengambil keputusan digital yang lebih aman.",
    ctaPrimary: "Mulai Scan", ctaSecondary: "Pelajari Sistem AI",
    ...
    howSteps: [
      ...
      { title: "Tunggu analisis AI", description: "TrustLens mengekstrak konteks dan membaca pola bahasa yang sering muncul dalam rekayasa sosial." },
    ...
    aiTitle: "Bagaimana AI TrustLens Bekerja",
    ...
    aiCards: [
      ...
      { title: "AI Threat Analysis", description: "Model membaca konteks, nada, pola permintaan, dan indikator social engineering untuk menyusun ringkasan risiko." },
      ...
      { title: "AI Confidence Analysis", description: "Tingkat keyakinan membantu pengguna membaca seberapa kuat sinyal yang ditemukan AI dalam percakapan." },
    ],
    ...
    faqItems: [
      ...
      { question: "Bagaimana AI analysis bekerja?", answer: "AI menganalisis teks percakapan, konteks, sinyal manipulasi, dan indikator phishing untuk memberi ringkasan risiko." },
  ...
  en: {
    eyebrow: "DOCUMENTS / LEARN",
    title: "AI Scam Intelligence & Education Hub",
    subtitle: "A premium guide to using TrustLens, decoding scam psychology, and making safer digital decisions.",
    ctaPrimary: "Start Scanning", ctaSecondary: "Explore AI System",
    ...
    howSteps: [
      ...
      { title: "Wait for AI analysis", description: "TrustLens extracts context and reads language patterns that commonly appear in social engineering." },
    ...
    scamTitle: "Modern Scam Type Map", scamDescription: "Recognize the most common patterns that appear in everyday scam conversations.",
    scamCards: [
    ...
    psychTitle: "Psychological Manipulation Guide",
    psychDescription: "Many scams succeed not because the technology is advanced, but because attackers understand how to pressure human emotion.",
    psychCards: [
    ...
    aiTitle: "How TrustLens AI Works",
    aiDescription: "This is a high-level, user-friendly explanation. TrustLens does not expose backend secrets, internal prompts, or API keys.",
    aiCards: [
      ...
      { title: "AI Threat Analysis", description: "The model reads context, tone, requests, and social engineering indicators to create a risk summary." },
      ...
      { title: "AI Confidence Analysis", description: "Confidence helps users interpret how strong the detected signals are within the conversation." },
    ],
    safetyTitle: "Safety Recommendations", safetyDescription: "Use these principles before sending money, private data, OTPs, documents, or account access.",
    ...
    faqTitle: "Frequently Asked Questions", faqDescription: "Short answers about accuracy, privacy, language support, and how to read TrustLens results.",
    faqItems: [
      { question: "Is TrustLens accurate?", answer: "TrustLens reads risk patterns with AI, but final decisions should still include human verification and supporting evidence." },
      ...
      { question: "How does AI analysis work?", answer: "AI analyzes conversation text, context, manipulation signals, and phishing indicators to produce risk insights." },
